...
echo "      Design Phase:"
echo "         /workflow-design-architecture - System architecture design"
echo "         /workflow-design-nextjs - Next.js application architecture"
echo ""
echo "      Implementation Phase:"
echo "         /workflow-implement-fullstack - Full-stack feature (DB → API → UI)"
echo "         /workflow-implement-frontend - Frontend components"
echo "         /workflow-implement-backend - Backend API & business logic"
echo ""
echo "      Review Phase:"
echo "         /workflow-review-code - Code quality review"
echo "         /workflow-review-security - Security audit (OWASP Top 10)"
echo "         /workflow-review-performance - Performance optimization"
echo ""
echo "      QA & Documentation:"
echo "         /workflow-qa-e2e - End-to-end testing with Playwright"
echo "         /workflow-write-docs - Technical documentation with MkDocs"
echo ""
echo "      Deployment:"
echo "         /workflow-deploy - Production deployment with CI/CD"
echo ""
...
echo "      /workflow-design-nextjs"
echo "      /workflow-implement-fullstack"
echo "      /workflow-review-code"
echo "      /workflow-review-security"
echo "      /workflow-qa-e2e"
echo "      /workflow-write-docs"
